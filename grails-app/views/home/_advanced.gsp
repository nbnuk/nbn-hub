...
<!--https://registry.nbnatlas.org/ws/dataProvider-->
    <div class="form-group not_done_yet" >
        <label class="col-md-2 control-label not_done_yet" for="basis-of-record">Data partners</label>
        <div class="col-md-6">
            <select class="form-control" name="basis-of-record" id="basis-of-record" style="height:33.9px">
...
<style>
/*.rs-container .rs-scale span ins, .rs-container.disabled .rs-scale span ins {*/
/*color:#fff;*/
/*}*/
...
.rs-pointer[data-dir="right"] .rs-tooltip {
